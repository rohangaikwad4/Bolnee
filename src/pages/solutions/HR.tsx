...
import { Users, BookOpen, FileText, Calendar, ArrowRight, Check } from 'lucide-react';
    ...
    <>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-violet-700 via-brand-600 to-violet-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-violet-100 mb-8 max-w-2xl mx-auto">Give every employee a personal HR assistant that\'s always available.</p>
