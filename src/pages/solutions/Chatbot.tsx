...
import { Bot, MessageSquare, FileText, Globe, Puzzle, ArrowRight, Check } from 'lucide-react';
    ...
    <>
            ...
            {steps.map((s, i) => (
              <div key={i} className="text-center">
                <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-2xl font-bold text-blue-600">{s.step}</span>
                </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">Get your first agent up and running in under 10 minutes — no coding required.</p>
