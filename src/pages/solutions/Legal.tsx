...
import { Scale, FileText, Calendar, HelpCircle, ArrowRight, Check, Users } from 'lucide-react';
    ...
    <>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">Let AI handle the paperwork so your attorneys can practice law.</p>
