      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 text-center">
            ...
            <p className="text-blue-200 mt-1 text-sm">Start your free Bolnee trial today</p>
          </div>
          <form className="p-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <label className="flex items-start gap-2.5">
              <input
                ...
                className="mt-0.5 rounded border-gray-300 text-blue-600 focus:ring-blue-600/20"
              />
              <span className="text-sm text-gray-600">
                I agree to the{' '}
                <Link to="/legal" className="text-blue-600 hover:text-blue-700 font-medium">Terms of Service</Link>
                {' '}and{' '}
                <Link to="/legal" className="text-blue-600 hover:text-blue-700 font-medium">Privacy Policy</Link>
              </span>
            </label>
            <button
              type="submit"
